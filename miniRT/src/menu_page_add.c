...
/*   Updated: 2024/09/27 16:03:45 by efret            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	menu_init_page_add(t_mlx_data *data, t_ui_menu *menu, t_ui_menu_page *page)
{
	...
	add_elem_space(page);
	add_elem_btn(page,
		"Add sphere", (t_elem_data){0, NULL}, menu_btn_add_sphere);
	add_elem_btn(page,
		"Add cylinder", (t_elem_data){0, NULL}, menu_btn_add_cylinder);
	add_elem_btn(page, "Add plane", (t_elem_data){0, NULL}, menu_btn_add_plane);
	add_elem_btn(page, "Add cone", (t_elem_data){0, NULL}, menu_btn_add_cone);
	return (0);
}
